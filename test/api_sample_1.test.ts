...
describe("getuser", () => {
  ...
  it("ut:getUser 失敗 パスパラメーター未指定", async () => {
    mockDynamoDBDocumentClient.on(GetCommand).resolves({ Item: { id: 1, name: "test_name" } });
  ...
  it("ut:getUser 失敗 パスパラメーター指定間違い", async () => {
    mockDynamoDBDocumentClient.on(GetCommand).resolves({ Item: { id: 1, name: "test_name" } });
    let event: APIGatewayProxyEvent = getDummyAPIGatewayProxyEvent();
  ...
  it("ut:getUser 失敗 idが数値変換不可", async () => {
    mockDynamoDBDocumentClient.on(GetCommand).resolves({ Item: { id: 1, name: "test_name" } });
    let event: APIGatewayProxyEvent = getDummyAPIGatewayProxyEvent();
  ...
  it("ut:getUser 失敗 idの範囲間違い", async () => {
    mockDynamoDBDocumentClient.on(GetCommand).resolves({ Item: { id: 1, name: "test_name" } });
    let event: APIGatewayProxyEvent = getDummyAPIGatewayProxyEvent();
  ...
  it("it:getUser ダミー1", async () => {});

  it("getUser ダミー2", async () => {});
});
